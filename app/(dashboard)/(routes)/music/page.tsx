...
const  MusicPage = () => {
  ...
  return (
    <div>
      ...
      description='Generate a powerful music using Lot-AI.'
      icon={Music}
                ...
                <FormField  name='prompt' render={({field}) => (
                    <FormItem className='col-span-12 lg:col-span-10'>
                        <FormControl className='m-0 p-0'>
                            <Input {...field} disabled={loading} className='border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent' placeholder='Piano solo' />
                        </FormControl>
